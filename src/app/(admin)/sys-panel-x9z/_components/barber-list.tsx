...
import { ShieldCheck, Ban, CalendarPlus } from "lucide-react";
                                ...
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end gap-2">
                                        ...
                                        <button
                                            ...
                                            className={`p-2 rounded-lg transition ${barber.isActive ? "text-red-600 hover:bg-red-50" : "text-green-600 hover:bg-green-50"
                                                }`}
                                        >
